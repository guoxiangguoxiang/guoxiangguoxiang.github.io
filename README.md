<div style="display: flex; flex-direction: column; justify-content: center; align-items: center">
  ...
  <div style="font-size: 18px;margin: 7px 0px">求职意向：前端开发 | 期望城市：深圳/北京/上海/杭州</div>
</div>

<div style="display: flex; flex-direction: column; justify-content: center; align-items: center">
  <div style="font-size: 24px; margin: 7px 0px"><strong>教育经历</strong></div>
</div>
...
<div style="display: flex; flex-direction: column; justify-content: center; align-items: center">
  <div style="font-size: 24px; margin: 7px 0px"><strong>技能清单</strong></div>
</div>
...
<div style="display: flex; flex-direction: column; justify-content: center; align-items: center">
  <div style="font-size: 24px; margin: 7px 0px"><strong>工作经历</strong></div>
</div>
...
<div style="display: flex; flex-direction: column; justify-content: center; align-items: center">
  <div style="font-size: 24px; margin: 7px 0px"><strong>项目经历</strong></div>
</div>
